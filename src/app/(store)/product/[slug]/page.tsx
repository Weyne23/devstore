    ...
    return (
        <div className="relative grid max-h-[860px] grid-cols-3">
            ...
            <div className="flex flex-col justify-center px-12">
                ...
                <button type="button" className="mt-8 flex h-12 items-center justify-center rounded-full bg-emerald-600 font-semibold text-white">Adicionar no carrinho</button>
            </div>
        </div>
    )
}